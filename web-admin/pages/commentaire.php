...
if (!isset($_SESSION['EMAIL_ADMIN'])) {
  ...
  $aff = commentaire::AfficherCommentaire();
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tous Les Commanteire</h4>
                    <div class="table-responsive">
                      <table class="table table-striped" style="text-align: center;">
                        ...
                        <tbody>
                          <?php    foreach($aff as $elm)      {   $img =  "../../images/commentaire/". $elm["IMG_C"]        ?>
                            <tr>
                              <td>#<?php echo $elm["ID_C"];   ?></td>
                              <td><img src="<?php if (file_exists($img)) { echo $img; } else { echo "../../images/commentaire/client.jpg"; }?>" alt="prod"></td>
                              <td><?php echo $elm["NOM_C"];   ?></td>
                              <td><?php echo $elm["DESC_C"];   ?></td>
                              <td>
                                <a href="supprimer_commentaire.php?id=<?php echo $elm["ID_C"]?>">
                      ...
                      <button style="margin-top: 20px;" type="button" class="btn btn-gradient-primary btn-rounded btn-fw">+ Ajoter categorie</button>
