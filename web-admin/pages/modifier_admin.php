...
if (!isset($_SESSION['EMAIL_ADMIN'])) {
  ...
  if($_SERVER["REQUEST_METHOD"] =="POST"){
    if(extract($_POST)){
      ...
      $v=Admin::getAdmin($_POST["id"]);
      $values=$v[0];
      Admin::ModifierAdmin($id,$EMAIL_ADMIN,$PASSWORD,$NOM_ADMIN,$LOCAL,$TELE_ADMIN);
                        ...
                        <div class="card-body">
                          <form class="forms-sample" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Nom du produit" name="NOM_ADMIN" value="<?php echo $values["NOM_ADMIN"]?>" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputName1">Email</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Email de ladmin" name="EMAIL_ADMIN" value="<?php echo $values["EMAIL_ADMIN"]?>" required>
                            </div>

                            <div class="form-group">
                              <label for="exampleInputPassword1">MOT DE PASSE</label>
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Password" name="PASSWORD" value="<?php echo $values["PASSWORD"]?>" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputName1">LOCAL</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Nom du produit" name="LOCAL" value="<?php echo $values["LOCAL"]?>" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputName1">TELEPHONE</label>
                                <div style="display: flex;"><p style="align-self: center;margin:0;margin-right:10px"><strong>+212</strong></p><input type="text" class="form-control" id="exampleInputName1" placeholder="Nom du produit" name="TELE_ADMIN" value="<?php echo $values["TELE_ADMIN"]?>" required></div>
                            </div>
