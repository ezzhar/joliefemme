                      ...
                      <table class="table table-striped">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th >
                              <strong style="margin-left: 30px;">État</strong>
                            </th>
                            <th>
                        ...
                        <tbody>
                              ...
                              <?php    foreach($aff as $elm)      {            ?>
                                <tr>

                                  <td> #<?php echo $elm["ID_PROD"];   ?> </td>
                                  <td> <?php echo substr( $elm["NOM_PROD"], 0, 15) . " . . ."   ?></td>
                                  <td><?php echo $elm["NOM_CAT"];   ?></td>
                                  <td><img src="../../images/produits/<?php echo $elm["IMG_PROD1"];   ?> " alt="prod"></td>
                                  <td>
                                    <p style="margin: 0; text-align: center; width: 110px; height: 30px;color:antiquewhite;
                                      background-color: <?php
                                        if ($elm["ETAT_PROD"] === "Indisponible") {
                                          echo "red";
                                        } elseif ($elm["ETAT_PROD"] === "Disponible") {
                                          echo "green";
                                        }
                                      ?>;display: flex;
                                      align-items: center;
                                      ...
                                      border-radius: 15px;">
                                      <strong><?php echo $elm["ETAT_PROD"]; ?></strong>
                                    </p>
                                  </td>
                                  <td>
                                    <div style="display: flex;">
                                    <a href="modifier_produit.php?id=<?php echo $elm["ID_PROD"]?>">
                                      <div>
                                        <img style="width:30px;height:30px;border-radius:0" src="../../images/icones/edit.svg" alt="x" >
                                      </div>
                                    </a>
                                    <a href="supprimer_produit.php?id=<?php echo $elm["ID_PROD"]?>">
