            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body">
                          <form class="forms-sample" method="post" action="fct_php/ajouter_prod.php" enctype="multipart/form-data">

                            <div class="form-group">
                                <label for="exampleInputName1">Nom</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Nom du produit" name="NOM_PROD">
                            </div>

                            <div class="form-group">
                              <label for="exampleSelectGender">Categorie</label>
                              <select   required type="text" class="form-control" name="ID_CAT" style="height: 50px;" >
                                <option  disabled selected > veuiller choisir la categorie </option>
                                <?php foreach ($cat as $elm) { $catname = categorie::getCategorie($elm["ID_CAT"]); ?>
                                  <?php foreach ($catname as $cat) {  ?>
                                    <option value="<?php echo $elm["ID_CAT"]; ?>">
                            ...
                            <div class="prics-pro" style="display: flex;">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="exampleInputPassword4" placeholder="prix" style="width: 300px;" name="PRIX">
                              </div>
                              <div class="form-group" style="margin-left: 20px;">
                                <label for="exampleInputPassword4">Ancien Prix</label>
                                <input type="number" class="form-control" id="exampleInputPassword4" placeholder="ancien prix" style="width: 300px;" name="OLD_PRIX">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <input type="file" id="inputGroupFile04" name="image2" aria-describedby="inputGroupFileAddon04" aria-label="Upload" class="file-upload-default">
                              <div class="input-group col-xs-12">
                                  <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                  <span class="input-group-append">
                                      <label class="file-upload-browse btn btn-gradient-primary" type="button">Upload</label>
                            ...
                            <div class="form-group">
                              <input type="file" id="inputGroupFile04" name="image3" aria-describedby="inputGroupFileAddon04" aria-label="Upload" class="file-upload-default">
                              <div class="input-group col-xs-12">
                                  <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                  <span class="input-group-append">
                                      <label class="file-upload-browse btn btn-gradient-primary" type="button">Upload</label>
                            ...
                            <div class="form-group">
                              <input type="file" id="inputGroupFile04" name="image4" aria-describedby="inputGroupFileAddon04" aria-label="Upload" class="file-upload-default">
                              <div class="input-group col-xs-12">
                                  <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                  <span class="input-group-append">
                                      <label class="file-upload-browse btn btn-gradient-primary" type="button">Upload</label>
                            ...
                            <div class="form-group">
                              <input type="file" id="inputGroupFile04" name="image5" aria-describedby="inputGroupFileAddon04" aria-label="Upload" class="file-upload-default">
                              <div class="input-group col-xs-12">
                                  <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                  <span class="input-group-append">
                                      <label class="file-upload-browse btn btn-gradient-primary" type="button">Upload</label>
                            ...
                            <div class="prics-pro" style="display: flex;">
                              <div class="form-group">
                                ...
                                <input type="color" class="form-control" id="exampleInputPassword4" placeholder="Password" style="height: 40px;width: 40px; padding: 5px;" name="COLOR_PROD">
                              </div>
                              <div class="form-group" style="margin-left: 20px;">
                              ...
                              <div class="form-group" style="margin-left: 20px;">
                                ...
                                <input type="number" class="form-control" id="exampleInputPassword4" placeholder="quantité du produit" style="width: 300px;" name="QTE_PROD">
                              </div>
                            </div>

                            <div class="form-group">
                                <label for="exampleTextarea1">Description</label>
                                <textarea class="form-control" id="exampleTextarea1" rows="7" name="DESC_PROD"></textarea>
                            </div>
