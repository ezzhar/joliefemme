...
if (!isset($_SESSION['EMAIL_ADMIN'])) {
  ...
  $aff = categorie::AfficherCategorie();
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tous Les Categories</h4>
                    <div class="table-responsive">
                      <table class="table table-striped" style="text-align: center;">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>
                              <strong>Quantité Des Prod</strong>
                            </th>
                          </tr>
                        </thead>
                        ...
                        <tbody>
                          <?php    foreach($aff as $elm)      {            ?>
                            <tr>
                              <td>#<?php echo $elm["ID_CAT"];   ?></td>
                              <td><img src="../../images/categories/<?php echo $elm["IMG_CAT"];   ?> " alt="prod"></td>
                              <td><?php echo $elm["NOM_CAT"];   ?></td>
                              <td><?php echo $elm["QTE_PROD_INCAT"];   ?></td>
                              <td>
                                <a href="supprimer_categorie.php?id=<?php echo $elm["ID_CAT"]?>">
                      ...
                      <a href="add_categorie.php"><button style="margin-top: 20px;" type="button" class="btn btn-gradient-primary btn-rounded btn-fw">+ Ajoter categorie</button></a>
