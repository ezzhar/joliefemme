                      ...
                      <table class="table table-striped">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>
                              <strong style="text-align: center;">État de la commande</strong>
                            </th>
                            <th>
                        ...
                        <tbody>
                          ...
                          <?php foreach($comm as $elm) {  $prod = Produit::getProduit( $elm["ID_PROD"]);   ?>
                            <tr>
                              ...
                              <td><?php echo  substr($elm["NOM_CLIENT"], 0, 15) . " . . ."   ?></td>
                              <td>
                                <p style="margin: 0; text-align: center; width: 100px; height: 25px;color:antiquewhite;
                                  background-color: <?php
                                    if ($elm["ETAT_COMM"] === "Retour") {
                                      echo "red";
                                    } elseif ($elm["ETAT_COMM"] === "Livré") {
                                      echo "green";
                                    } elseif ($elm["ETAT_COMM"] === "En Cour") {
                                      echo "orange";
                                    }
                                  ?>;display: flex;
                                  align-items: center;
                                  ...
                                  border-radius: 15px;">
                                  <strong><?php echo $elm["ETAT_COMM"]; ?></strong>
                                </p>
                              </td>
