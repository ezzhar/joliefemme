         ...
         <div class="container">
            <div class="row">
               <div class="col-md-4">
                  <div class="box ">
                     <div class="img-box">
                        <img src="images/icones/telephone.png" alt="" >
                     </div>
                     <div class="detail-box">
                        <p style="font-size: 20px;">
                           +212 <?php foreach($admin as $elm) { echo $elm["TELE_ADMIN"]; } ?>
                        </p>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="box ">
                     <div class="img-box">
                        <img src="images/icones/enveloppe.png" alt="" >
                     </div>
                     <div class="detail-box">
                        <p style="font-size: 20px;">
                        <?php foreach($admin as $elm) { echo $elm["EMAIL_ADMIN"]; } ?>
                        </p>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="box " style="text-align: center;">
                     <div class="img-box">
                        <img src="images/icones/whatsapp.png" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           <a href="https://wa.me/<?php foreach($admin as $elm) { echo $elm["TELE_ADMIN"]; } ?>?text=Je%20porte%20un%20grand%20intérêt%20à%20votre%20boutique.%20Serait-il%20possible%20de%20vous%20poser%20une%20question%20?" style="color: rgb(221, 221, 221);"><p > cliquez ici</p></a>
                        </h5>
                     </div>
                  </div>
               </div>
